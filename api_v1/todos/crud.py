...
async def create_todo(session: AsyncSession, todo_in: ToDoCreate) -> ToDo | None:
...
async def update_todo(session: AsyncSession, todo: ToDo, todo_update: ToDoUpdate | ToDoPartialUpdate, partial: bool = False) -> ToDo:
...
# async def partial_update_todo(session: AsyncSession, todo: ToDo, todo_update: ToDoPartialUpdate):
